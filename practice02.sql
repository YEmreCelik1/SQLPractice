...
insert into child values(101,1008,'Radio','Joyce Jonathan');
--SORU 2: .child tablosuna ted_verginosu 105 olan veri girişi yapınız.
insert into child values(105,1234,'Radio','Joyce Jonathan');
--ustteki kod calismaz cunku parent tabloda olmayan primary key ile child
--tabloya veri girisi yapamayiz.

--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child values (null,1009,'Radio','Joyce Jonathan');

--SORU 4: .parent tablosundaki vergi_no 101 olan veriyi siliniz
--	child dan veri silmeden parent dan veri silemeyiz
--bunun isin on delete cascade kullanmaliyiz.
...
--parent2 tablosunu siliniz
drop table parent2 cascade; 
--on delete cascade sayesinde child tablo silinmeden parent tablo siliebildi.
--child2 tablosunu silelim
drop table child2;
